...
const AboutUs = () => {
    return (
        <div className="aboutus_container">
            ...
            <p style={{fontSize: '20px', marginRight: '20px'}}>With a commitment to efficiency and innovation, we empower individuals and businesses to take control of their finances and achieve their goals with ease.</p>
